...
const TIME_SHEETS = [SH.LEACHING, SH.FILTER, SH.CYCLONE];
...
function _buildLeachingParams() {
  ...
  LT_TANKS.forEach(t => {
    params.push({ key: `${t} NaCN (ppm)`,         label: 'NaCN',          unit: 'ppm', tank: t, tankGroup: 'Leach' });
    params.push({ key: `${t} pH`,                 label: 'pH',            unit: '',    tank: t, tankGroup: 'Leach' });
    params.push({ key: `${t} DO (ppm)`,           label: 'DO',            unit: 'ppm', tank: t, tankGroup: 'Leach' });
...
function _buildCarbonParams() {
  const params = [{ key: 'Date', label: 'Date', unit: '', isText: true }];
...
const SHEET_PARAMS = {
  ...
  [SH.FILTER]: [
    ...
    { key: 'Feed Rate',     label: 'Feed Rate',     unit: 'm³/hr' },
    { key: 'Pressure',      label: 'Pressure',      unit: 'bar'   },
    { key: 'Cake Moisture', label: 'Cake Moisture', unit: '%'     },
    { key: 'Au',            label: 'Au',            unit: 'ppm'   },
    { key: 'Cu',            label: 'Cu',            unit: 'ppm'   },
    { key: 'Fe',            label: 'Fe',            unit: 'ppm'   },
    { key: 'Notes',         label: 'Notes',         unit: '',      isText: true },
  ],
  [SH.CYCLONE]: [
    { key: 'Date',          label: 'Date',          unit: '',      isText: true },
